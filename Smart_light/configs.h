...
#define DEFAULT_COLOR_PALETTE "Forest"
#define DEFAULT_COLOR_CYCLE_TIME 20
#define DEFAULT_SPLIT_CYCLE_TIME 1000
#define DEFAULT_PALLETTE_CYCLE_TIME 10
#define NUMBER_OF_PALLETTES_DEFINED 6
